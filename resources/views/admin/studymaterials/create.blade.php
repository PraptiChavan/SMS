            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.studymaterials') }}" id="backToStudy-Material">Study-Material</a></li>
...
<script>
    $(document).ready(function() {
        $('#addStudy-MaterialForm').on('submit', function(event) {
            ...
            $.ajax({
                url: "{{ route('admin.studymaterials.store') }}",
                method: "POST",
                data: formData,
                contentType: false,
                processData: false,
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $('#loadingOverlay').show();
                            window.location.href = "{{ route('admin.studymaterials') }}";
                        }
                    });
                },
                error: function(xhr) {
