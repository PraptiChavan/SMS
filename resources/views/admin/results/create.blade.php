            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.results') }}" id="backToResults">Result</a></li>
    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="addResultForm" enctype="multipart/form-data" method="POST" action="{{ route('admin.results.store') }}">
                        @csrf
...
<script>
    $(document).ready(function () {
        $('#exam_name').on('change', function () {
            ...
            if (examId) {
                $.ajax({
                    url: '/admin/get-exam-total/' + examId,
                    type: 'GET',
    ...
    $(document).ready(function () {
        $('#student_name, #classes, #sections, #exam_name').on('change', function () {
            ...
            if (studentName && classId && sectionId && examId) {
                $.ajax({
                    url: "{{ route('admin.results.checkDuplicate') }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
