    ...
    <div class="app-content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                    <h6 style="margin-top: 10px; margin-bottom: 10px;"><b>Find Student's Attendance</b></h6>
...
<script>
    $(document).ready(function () {
        ...
        function loadAttendanceData() {
            ...
            $.ajax({
                url: `{{ url('get-student-attendance') }}/${studentId}?month=${currentMonth}&year=${currentYear}`,
                type: 'GET',
                dataType: 'json',
                success: function (data) {
                    ...
                    for (let day = 1; day <= totalDays; day++) {
                        ...
                        let dayOfWeek = (firstDayOfWeek + day - 1) % 7; // Get the current day's position in the week

                        // If it's Sunday, make it grey and remove the attendance count
                        if (dayOfWeek === 0) {
        ...
        // Function to change the month and reload attendance
