...
class ResultController extends Controller
{
    public function index()
    {
        ...
        return view('admin.results.results', compact('classes', 'sections', 'results', 'examform', 'subjects'));
    }
    ...
    public function create()
    {
        ...
        $examform = ExamForm::selectRaw('MIN(id) as id, name')->groupBy('name')->get();
        $subjects = SubjectModel::all();
        return view('admin.results.create', compact('sections', 'classes', 'examform', 'subjects'));// View for adding a new section
    }
    ...
    public function store(Request $request)
    {
        ...
        // ✅ Generate PDF file
        $pdf = Pdf::loadView('admin.results.pdf', $pdfData)->setPaper('A4', 'portrait');
        ...
        return redirect()->route('admin.results')->with('success', 'Result generated successfully!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.results.edit', compact('classes', 'sections', 'result', 'examform', 'subjects', 'students', 'selectedStudent'));
    }
